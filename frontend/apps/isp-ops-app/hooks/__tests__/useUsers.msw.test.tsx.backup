/**
 * MSW-powered tests for useUsers
 *
...
describe("useUsers (MSW)", () => {
  ...
  describe("useUsers - fetch users", () => {
    ...
    it("should handle fetch error", async () => {
      makeApiEndpointFail("get", "/users", "Server error");
  ...
  describe("useUpdateUser", () => {
    ...
    it("should handle update error", async () => {
      makeApiEndpointFail("put", "/users/user-1", "Update failed", 400);
  ...
  describe("useDeleteUser", () => {
    ...
    it("should handle delete error", async () => {
      makeApiEndpointFail("delete", "/users/user-1", "Delete failed", 404);
  ...
  describe("useDisableUser", () => {
    it("should disable user successfully", async () => {
      const user = createMockUser({ id: "user-1", is_active: true });
      seedUserData([user]);
    ...
    it("should handle disable error", async () => {
      makeApiEndpointFail("post", "/users/user-1/disable", "Disable failed", 400);
  ...
  describe("useEnableUser", () => {
    it("should enable user successfully", async () => {
      const user = createMockUser({ id: "user-1", is_active: false });
      seedUserData([user]);
    ...
    it("should handle enable error", async () => {
      makeApiEndpointFail("post", "/users/user-1/enable", "Enable failed", 400);
  ...
  describe("Real-world scenarios", () => {
    ...
    it("should update user and invalidate queries", async () => {
      const user = createMockUser({ id: "user-1", full_name: "Original Name" });
      seedUserData([user]);
      ...
      // Queries should be invalidated and refetched
      await waitFor(() => {
