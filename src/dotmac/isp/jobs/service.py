...
from dotmac.isp.jobs.models import Job, JobStatus
...
# Stub for realtime publishing - in split architecture, this goes via Platform API
async def publish_job_update(
    ...
    """
    Publish job update to realtime channel.

    NOTE: This is a stub. In the split architecture, realtime updates
    should be sent via the Platform's WebSocket/SSE infrastructure.
    """
    import structlog
...
from dotmac.shared.redis_client import RedisClientType
