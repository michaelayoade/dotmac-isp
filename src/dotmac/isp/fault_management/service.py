...
class AlarmService:
    ...
    async def create_ticket_from_alarm(
        ...
        from dotmac.isp.ticketing.models import TicketActorType, TicketPriority, TicketType
        from dotmac.isp.ticketing.schemas import TicketCreate
        from dotmac.isp.ticketing.service import TicketService
