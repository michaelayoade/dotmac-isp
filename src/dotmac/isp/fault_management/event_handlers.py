...
from dotmac.shared.events.core import Event, event_bus
from dotmac.isp.fault_management.models import Alarm, AlarmSeverity, AlarmSource
...
async def handle_device_up(event: Event, session: AsyncSession) -> None:
    ...
    from dotmac.isp.fault_management.models import Alarm, AlarmStatus
...
async def handle_alarm_resolved(event: Event, session: AsyncSession) -> None:
    ...
    from dotmac.isp.fault_management.models import Alarm
