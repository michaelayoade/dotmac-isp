"""
Network Monitoring API Router (ISP-local)
...
async def get_network_overview(
    ...
    try:
        ...
        logger.error("Failed to get network overview", error=str(e), tenant_id=current_user.tenant_id)
        raise HTTPException(
...
async def list_devices(
    ...
    try:
        ...
        logger.error("Failed to list devices", error=str(e), tenant_id=current_user.tenant_id)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_alerts(
    ...
    try:
        ...
        logger.error("Failed to list alerts", error=str(e), tenant_id=current_user.tenant_id)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def create_alert_rule(
    ...
    try:
        ...
        logger.error("Failed to create alert rule", error=str(e), tenant_id=current_user.tenant_id)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_alert_rules(
    ...
    try:
        ...
        logger.error("Failed to list alert rules", error=str(e), tenant_id=current_user.tenant_id)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
