...
from dotmac.isp.project_management.jinja_utils import render_template
from dotmac.isp.project_management.models import (
    Project,
    ProjectStatus,
    Team,
)
from dotmac.isp.project_management.schemas import ProjectCreate, TaskCreate
from dotmac.isp.project_management.service import ProjectManagementService
from dotmac.isp.project_management.templates import (
    ProjectTemplate,
...
async def find_best_team(
    ...
    if required_team_type:
        from dotmac.isp.project_management.models import TeamType
...
async def handle_order_completed_create_project(event: Event) -> None:
    ...
    # Fetch order details
    try:
        from dotmac.isp.sales.models import Order
