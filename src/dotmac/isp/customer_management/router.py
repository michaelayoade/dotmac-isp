...
from dotmac.isp.customer_management.models import CustomerStatus
...
async def _handle_status_lifecycle_events(
    ...
    try:
        ...
        if (
            ...
            from dotmac.isp.billing.models import BillingSubscriptionTable
            from dotmac.isp.billing.subscriptions.models import SubscriptionStatus
            from dotmac.isp.billing.subscriptions.service import SubscriptionService
            from dotmac.shared.events.bus import get_event_bus
...
async def get_customer_metrics(
    ...
    Requires authentication.
    """
    from dotmac.isp.customer_management.schemas import CustomerSegmentSummary
...
async def impersonate_customer(
    ...
    """
    from dotmac.shared.audit import ActivitySeverity, ActivityType, log_user_activity
...
async def update_customer_status(
    ...
    try:
        ...
        from dotmac.isp.customer_management.schemas import CustomerUpdate
