...
from dotmac.shared.core import Money

from dotmac.isp.billing.core.entities import (
    InvoiceEntity,
    PaymentEntity,
)
from dotmac.isp.billing.core.models import Invoice as InvoiceModel
from dotmac.isp.billing.core.models import Payment as PaymentModel
from dotmac.isp.billing.subscriptions.models import Subscription as SubscriptionModel
...
class InvoiceMapper:
    ...
    def to_entity(invoice: Invoice) -> InvoiceEntity:
        ...
        """
        from dotmac.isp.billing.core.core.enums import InvoiceStatus, PaymentStatus
...
class PaymentMapper:
    ...
    def to_entity(payment: Payment) -> PaymentEntity:
        ...
        from dotmac.isp.billing.core.core.enums import PaymentMethodType
        ...
        from dotmac.isp.billing.core.core.enums import PaymentStatus
    ...
    def to_model(payment: Payment) -> PaymentModel:
        ...
        from dotmac.isp.billing.core.core.enums import PaymentMethodType, PaymentStatus
...
class SubscriptionMapper:
    ...
    def to_model(subscription: Subscription) -> SubscriptionModel:
        ...
        from dotmac.isp.billing.subscriptions.models import SubscriptionStatus
