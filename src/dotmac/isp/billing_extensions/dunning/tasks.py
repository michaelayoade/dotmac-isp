...
from dotmac.isp.celery_app import celery_app
...
async def _send_dunning_email(
    ...
    try:
        ...
        from dotmac.shared.communications.task_service import send_single_email_task
...
async def _send_dunning_sms(
    ...
    try:
        ...
        async with async_session_maker() as session:
            ...
            # Get SMS integration
            from dotmac.isp.integrations import get_integration_async
