...
from dotmac.isp.billing.core import AddonNotFoundError
from dotmac.isp.billing.models import BillingAddonTable, BillingTenantAddonTable
...
class AddonService:
    ...
    async def purchase_addon(
        ...
        from dotmac.isp.billing.integration import BillingIntegrationService
        ...
        from dotmac.isp.billing.invoicing.service import InvoiceService
        ...
        if tenant_addon.current_period_end and tenant_addon.current_period_start:
            ...
            if quantity_diff > 0:
                ...
                if not invoice_id:
                    ...
                    from dotmac.isp.billing.core.entities import InvoiceEntity
                ...
                from dotmac.isp.billing.core.core.enums import CreditReason

                from dotmac.isp.billing.credit_notes.service import CreditNoteService
