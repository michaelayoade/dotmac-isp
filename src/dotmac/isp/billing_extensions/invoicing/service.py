...
import structlog
from dotmac.isp.billing.core.core.enums import InvoiceStatus, PaymentStatus, TransactionType
from dotmac.isp.billing.core.core.exceptions import (
...
from dotmac.isp.billing.core.entities import (
    InvoiceEntity,
    InvoiceLineItemEntity,
    TransactionEntity,
)
from dotmac.isp.billing.core.models import Invoice, InvoiceLineItem
from dotmac.isp.billing.currency.service import CurrencyRateService
from dotmac.isp.billing.metrics import get_billing_metrics
from dotmac.isp.billing.money_utils import money_handler
...
class InvoiceService:
    ...
    async def send_invoice_email(
        ...
        try:
            ...
            from dotmac.shared.communications.email_service import EmailMessage, get_email_service
            from dotmac.shared.settings import settings
...
""".strip()
    ...
    async def _send_invoice_notification(self, invoice: InvoiceEntity) -> None:
        ...
        try:
            ...
            from dotmac.isp.billing.settings.service import BillingSettingsService
...
Please do not reply to this email.
            ...
            from dotmac.shared.audit import ActivityType, log_system_activity
