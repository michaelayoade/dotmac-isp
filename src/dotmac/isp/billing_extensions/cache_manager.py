...
from dotmac.isp.billing.cache import (
    BillingCache,
    BillingCacheConfig,
    get_billing_cache,
)
from dotmac.isp.billing.cache_handlers import (
    BulkImportHandler,
    CachePatternHandler,
    PlanCreatedHandler,
    PlanUpdatedHandler,
...
class BillingCacheManager:
    ...
    async def warm_cache_for_tenant(self, tenant_id: str) -> Any:
        ...
        try:
            ...
            from dotmac.isp.billing.catalog.cached_service import CachedProductService
        ...
        try:
            ...
            from dotmac.isp.billing.pricing.cached_service import CachedPricingEngine
