...
from dotmac.isp.billing._typing_helpers import idempotent_task, shared_task
from dotmac.isp.billing.reconciliation_service import ReconciliationService
...
async def _auto_reconcile_impl(
    ...
    async with AsyncSessionLocal() as db:
        ...
        from dotmac.isp.billing.bank_accounts.entities import ManualPayment
...
async def _schedule_reconciliation_impl(
    ...
    async with AsyncSessionLocal() as db:
        ...
        from dotmac.isp.billing.bank_accounts.entities import PaymentReconciliation
...
#         'task': 'dotmac.billing.reconciliation_tasks.auto_reconcile_cleared_payments',
#         'schedule': crontab(hour=2, minute=0),  # Run daily at 2 AM
#     },
#     'retry-failed-payments-batch': {
#         'task': 'dotmac.billing.reconciliation_tasks.retry_failed_payments_batch',
#         'schedule': crontab(hour='*/6'),  # Run every 6 hours
#     },
#     'generate-daily-reconciliation-report': {
#         'task': 'dotmac.billing.reconciliation_tasks.generate_daily_reconciliation_report',
#         'schedule': crontab(hour=23, minute=55),  # Run daily at 11:55 PM
#     },
#     'monitor-circuit-breaker-health': {
#         'task': 'dotmac.billing.reconciliation_tasks.monitor_circuit_breaker_health',
