...
from dotmac.isp.billing.domain.aggregates import Invoice, InvoiceLineItem
from dotmac.shared.core.aggregate_root import Money
...
def fastapi_app():
    ...
    from dotmac.shared.tenant_app import create_tenant_app
...
class TestPaymentMethods:
    ...
    def test_list_payment_methods_success(
        ...
        from dotmac.isp.billing.payment_methods.models import PaymentMethodResponse
