...
if HAS_SQLALCHEMY:
    ...
    if TYPE_CHECKING:
        ...
        from dotmac.isp.billing.core.entities import PaymentMethodEntity
        from dotmac.isp.billing.models import BillingSubscriptionPlanTable
    ...
    async def test_payment_method(
        ...
        from dotmac.isp.billing.core.entities import PaymentMethodEntity
        from dotmac.isp.billing.core.enums import PaymentMethodStatus, PaymentMethodType
    ...
    async def test_subscription_plan(
        ...
        from dotmac.isp.billing.models import BillingSubscriptionPlanTable
        from dotmac.isp.billing.subscriptions.models import BillingCycle
